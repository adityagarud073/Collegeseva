...
import { cookieOptions, getDataUri, sendEmail, sendJwtToken } from "../utils/features.js";
...
export const login = asyncError(async (req, res, next) => {
  ...
  sendJwtToken(user, res, `Welcome Back, ${user.name}`, 200);
});
...
export const register = asyncError(async (req, res, next) => {
  ...
  sendJwtToken(user, res, `Registered Successfully`, 201);
});
