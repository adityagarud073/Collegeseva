    ...
    <div className='mt-20 h-full mx-10 mb-10'>
      ...
      <TimelineOppositeContent
        ...
        <TimelineContent sx={{ py: '12px', px: 2 }}>
          ...
          <Typography>Fill up the application form.</Typography>
        </TimelineContent>
      </TimelineItem>
      <TimelineItem>
      <TimelineOppositeContent
        ...
        <TimelineContent sx={{ py: '12px', px: 2 }}>
          ...
          <Typography>For Post-graduate admissions will be finalized only after June of the Academic year in which the form is submitted.</Typography>
        </TimelineContent>
      </TimelineItem>
      <TimelineItem>
      <TimelineOppositeContent
        ...
        <TimelineContent sx={{ py: '12px', px: 2 }}>
          ...
          <Typography>The student pays the eligible fee, submits proof of payment to the Admission Team. Upon receipt of payment the student gets the “Provisional Admission Letter”
</Typography>
        </TimelineContent>
      </TimelineItem>
      <TimelineItem>
